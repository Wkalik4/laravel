...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="card-footer text-center">
                    <a href="<?php echo e(route('login')); ?>"><?php echo e(__('Уже зарегистрированы?')); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\home\katalog.local\resources\views/auth/register.blade.php ENDPATH**/ ?>